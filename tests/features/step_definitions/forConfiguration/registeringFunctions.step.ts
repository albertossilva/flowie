...
Given('a registered function called {string} that receives {string} and returns {string}', function (
  this: ConfigurationFlowieWorld,
  functionName: string,
  argument: string,
  result: string,
) {
...
Given('a registered function called {string} that returns {string} receiving', function (
  this: ConfigurationFlowieWorld,
  functionName: string,
  result: string,
  argumentJSON: string,
...
Given('an async registered function called {string} that receives {string} and resolves {string}', function (
  this: ConfigurationFlowieWorld,
  functionName: string,
  argument: string,
  result: string,
...
Given('a registered generator function called {string} that receives {string} and yields:', function (
  this: ConfigurationFlowieWorld,
  functionName: string,
  argument: string,
  yieldsJSON: string,
...
Given('a registered generator function called {string} that receives the keys and return the values', function (
  this: ConfigurationFlowieWorld,
  functionName: string,
  keyYieldsJSON: string,
) {
