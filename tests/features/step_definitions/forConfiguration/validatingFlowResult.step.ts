...
Then('the result should be {string} for flow from configuration: {string}', function (
...
Then('the result of flow from configuration: {string} is', function (
  this: ConfigurationFlowieWorld,
  flowName: string,
...
Then('the promise result is {string} for flow from configuration: {string}', async function (
  this: ConfigurationFlowieWorld,
  expectedResult: string,
  flowName: string,
) {
