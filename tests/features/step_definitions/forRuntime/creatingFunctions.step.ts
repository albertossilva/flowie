...
Given('a function called {string} that receives {string} and returns {string}', function (
  this: RuntimeFlowieWorld,
  functionName: string,
  argument: string,
  result: string,
) {
...
Given('a function called {string} that returns {string} receiving', function (
  this: RuntimeFlowieWorld,
  functionName: string,
  result: string,
  argumentJSON: string,
...
Given('an async function called {string} that receives {string} and resolves with {string}', function (
  this: RuntimeFlowieWorld,
  functionName: string,
  argument: string,
  result: string,
...
Given('a generator function called {string} that receives {string} and yields:', function (
  this: RuntimeFlowieWorld,
  functionName: string,
  argument: string,
  yieldsJSON: string,
...
Given('a generator function called {string} that receives the keys and return the values', function (
  this: RuntimeFlowieWorld,
  functionName: string,
