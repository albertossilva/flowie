...
Then('the result should be {string} for flow {string}', function (
...
Then('the promise result is {string} for flow {string}', async function (
  this: RuntimeFlowieWorld,
  expectedResult: string,
  flowName: string,
) {
...
Then('the promise result of flow {string} is', async function (
  this: RuntimeFlowieWorld,
  flowName: string,
  resultMatch: string,
) {
