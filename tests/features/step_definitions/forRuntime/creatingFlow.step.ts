...
When('I create a flow named {string} with {string}', function (
  this: RuntimeFlowieWorld,
  flowName: string,
  firstFunctionsNamesList: string,
) {
  this.createFlow(flowName, ...firstFunctionsNamesList.split(','))
})

When('I pipe to {string} on flow {string}', function (
  this: RuntimeFlowieWorld,
  functionName: string,
  flowName: string,
) {
...
When('I split to {string} on flow {string}', function (
  this: RuntimeFlowieWorld,
