...
// import { mock, stub, spy, assert as sinonAssert, SinonStub } from 'sinon'
...
//           const flow = flowie(commonFunction)
...
//           const flow = flowie(firstFunction).pipe(secondFunction)
...
//           const firstFunctionReturn = 'RESULT'
//           const firstFunction = createSimpleFunctionMock(parameter, firstFunctionReturn)
//           const middleWareFunction = createSimpleFunctionMock(firstFunctionReturn, firstFunctionReturn, 7)

//           const lastFunction = createSimpleFunctionMock(firstFunctionReturn, expected)

//           const flow = flowie(firstFunction)
//             .pipe(middleWareFunction)
//             .pipe(middleWareFunction)
//             .pipe(middleWareFunction)
//             .pipe(middleWareFunction)
//             .pipe(flowie(middleWareFunction).pipe(middleWareFunction))
//             .pipe(middleWareFunction)
//             .pipe(lastFunction)
